...
% INPUTS:
% ---------
% MAPzmatrixpath = path to MAP elevation mat file matrix
...
MAPz=load(MAPzmatrixpath);
MAPz=MAPz.meanMAPz;

% GEM name
MAPname=split(MAPzmatrixpath,'/');
MAPname=MAPname(8,1);
MAPname=string(MAPname);
MAPdate=datetime(str2num(MAPname),'ConvertFrom','epochtime','TicksPerSecond',1000);
...
ztran = median(MAPz(iy-iyavg:iy+iyavg,:,:),1,'omitnan');
