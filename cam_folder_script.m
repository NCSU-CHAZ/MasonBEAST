...
campath=append(epochpath,'/CamB'); % '/CamB' '/CamA' (path to already moved files not in order)
newcampath=append(epochpath,'/Cam_B');
...
epochs_num=sscanf(epochs_str,'._CameraB_%d.tiff#'); % remember to change to A or B
