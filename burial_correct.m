function[Snn_d,ekz]=burial_correct(Snn,f,zbeg,zend,MWL,nbursts,NFFT,savepath)
% function[Snn_d]=depth_att(Snn)
% 
% This function corrects the elevation spectra for burial of a sensor.
% 
% INPUTS:
% --------
